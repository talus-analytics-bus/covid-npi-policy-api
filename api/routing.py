...
@app.post("/post/export", tags=["Downloads"])
...
@app.get("/get/metadata", response_model=MetadataList, tags=["Metadata"])
...
@app.get("/get/file/redirect", tags=["Downloads"])
...
@app.get("/get/file/{title}", tags=["Downloads"])
...
@app.post("/post/policy", response_model=ListResponse, response_model_exclude_unset=True, tags=["Policies"])
...
@app.get("/get/challenge", response_model=ListResponse, response_model_exclude_unset=True, tags=["Court challenges"], include_in_schema=False)
...
@app.post("/post/policy_status/{geo_res}", response_model=PolicyStatusList, response_model_exclude_unset=True, tags=["Policies"])
...
@app.post("/post/policy_status_counts/{geo_res}", response_model=PolicyStatusCountList, response_model_exclude_unset=True, tags=["Policies"])
async def post_policy_status(body: PolicyFilters, geo_res=str):
...
@app.post("/post/challenge", response_model=ListResponse, response_model_exclude_unset=True, tags=["Court challenges"])
...
@app.post("/post/plan", response_model=ListResponse, response_model_exclude_unset=True, tags=["Plans"])
async def post_plan(
    body: PolicyFilters,
    by_category: str = None,
    fields: List[str] = Query(None),
...
@app.get("/get/optionset", response_model=OptionSetList, tags=["Metadata"])
